    ...
    public class NumberTextConverterTest
    {
        ...
        public void NumberToWordTest()
        {
            ...
            foreach (var input in inputs)
            {
                ...
                //	Debugger.Launch();
                //}
                Assert.AreEqual(expectedResults[index], Converter.IntegerToWritten(input, false));
        ...
        public void InvalidNegativeNumber()
        {
            ...
            Exception ex = Assert.ThrowsException<NumberTextConverterException>(() => Converter.IntegerToWritten("-12323", false));

            Assert.AreEqual("Invalid number", ex.Message);
        ...
        public void NumberTooBig()
        {
            ...
            Exception ex = Assert.ThrowsException<NumberTextConverterException>(() => Converter.IntegerToWritten("99999999999999999999999999999999999999", false));

            Assert.AreEqual("Number too big", ex.Message);
        ...
        public void WordToNumberTest()
        {
            ...
            foreach (var input in inputs)
            {
                ...
                Assert.AreEqual(expectedResults[index], Converter.WrittenToInteger(input));
